...
return [
    ...
    */
    'user_models' => [
        'users' => \ftsda3\auths\Models\User::class,
    ],
    ...
    */
    'models' => [
        ...
        'role' => \ftsda3\auths\Models\Role::class,

        'permission' => \ftsda3\auths\Models\Permission::class,

        /**
         * Will be used only if the teams functionality is enabled.
         */
        'team' => \ftsda3\auths\Models\Team::class,
    ],
